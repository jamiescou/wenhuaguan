...
const documentRequests = {
     ...
     */
    getDocumentList(str, page, size) {
        return Fetch({
            url: '/collect/activitys?' + str + pageInfo(page, size),
            method: 'get'
        });
    },
    /**
    ...
    getDocumentPic(id) {
        return Fetch({
            url: '/collect/activitys/' + id + '/coverPic',
            method: 'get',
            responseType: 'blob'
        });
    },
    ...
    changeDocumentOnline(id, dataForm) {
        return Fetch({
            url: '/collect/activitys/' + id + '/onlineStatus',
            method: 'put',
            data: dataForm
        });
    },
    ...
    DocumentPublish(id, isPublish) {
        return Fetch({
            url: '/collect/activitys/' + id + '/publish/' + isPublish,
            method: 'put'
        });
    },
    /**
    ...
    exportWorks(id, param) {
        return Fetch({
            url: '/collect/works/'+ id +'/exportExcel',
            // data: param,
            method: 'post',
            responseType: 'blob'
        });
