<template>
    <div class="view-wrapper">
        <v-pageheader :breadcrumbs="[{ to:'index',name: '文化团队管理' },{name:'文化团队详细信息'}]"></v-pageheader>
        <div style="margin-top:20px;">
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <v-detailItem label="团队负责人" :value="viewForm.contactName"></v-detailItem>
                </el-col>
            </el-row>
...
export default {
    ...
    methods: {
        ...
        getDetail(id) {
            Api.cultureteam.getCultureTeamDetail(id).then((res) => {
                let artType = [];
