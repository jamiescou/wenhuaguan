    ...
    <div class="venueManage">
        ...
        <section class="search-wrapper">
            <el-form :inline="true" :model="searchForm" label-width="0">
                ...
                <el-form-item>
                    <el-select v-model="searchForm.venue.id" placeholder="请选择所属场馆">
        ...
        <roomsTable :flag="4" :search="searchStr" key="RECYCLED"></roomsTable>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            pageName: PARENT_NAME['4'].name,
            searchForm: { venue: { id: '' }, name: '', unit: '', status: '' },
            searchStr: 'searchUnitId,onlineStatus:' + roomStatus.STATUS.RECYCLED
        }
    },
    methods: {
        // 查询
        loadData() {
            ...
            str += 'onlineStatus:' + roomStatus.STATUS.RECYCLED;
