<template>
    <div class="view-wrapper">
        ...
        <div style="margin-top:20px;">
            ...
            <v-detailItem label="志愿者头像" :value="viewForm.avatar" type="image" class="cover"></v-detailItem>
...
export default {
    ...
    methods: {
        ...
        getDetail(id,type) {            
            ...
            str += ',idNumber:' + id;
            str += ',type:' + type;
            Api.nouns.getVolunteerList(str, 1, -1).then((resconte) => {     
                let res= resconte.content[0];
