...
const DIALOG = {
    add: { title: '新增数字资源', flag: 'add' },
    edit: { title: '编辑数字资源', flag: 'edit' }
};
        ...
        submitForm() {
            this.$refs['digitInfoForm'].validate((valid) => {
                ...
                if (this.flag === DIALOG.add.flag) {
                    ...
                    Api.nouns.addVolunrecruitDigitinfos(this.id, this.digitInfoForm).then(this.callback);
                } else {
                    ...
                    Api.nouns.editVolunrecruitDigitinfos(this.id, this.did, this.digitInfoForm).then(this.callback);
                }
            });
        },
        getDetail() {
