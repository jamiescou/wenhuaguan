...
const breadcrumbObj = {
    'activity': [{ name: '活动发布', to: 'activitypublish' }, { name: '活动纪实', to: { path: 'recordadd' } }],
    'venues': [{ name: '场馆管理', to: 'venues' }, { name: '场馆纪实', to: { path: 'recordadd' } }],
    'volunteer': [{ name: '志愿者活动', to: 'volunteer' }, { name: '活动风采纪实' }],
    'heritage': [{ name: '名录管理', to: '/heritage/directory/pulish' }, { name: '数字资源' }],
    'heritage': [{ name: '传承人管理', to: '/heritage/successor/pulish' }, { name: '数字资源' }]
};
...
export default {
    ...
    created() {
        ...
        let bdcrumbs = breadcrumbObj[flag];
        bdcrumbs[1].to.query = { id: this.id };
        bdcrumbs[2] = { name: this.title };
