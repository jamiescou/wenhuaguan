<template>
    <div class="view-wrapper">
        ...
        <div style="margin-top:20px;">
            ...
            <el-row>
                <el-col :span="12">
                    <v-detailItem label="姓名" :value="viewForm.user.name"></v-detailItem>
                    <v-detailItem label="性别" :value="viewForm.user.sex"></v-detailItem>
                    <v-detailItem label="出生年月" :value="viewForm.user.birthday"></v-detailItem>
                    <v-detailItem label="专业类别" :value="viewForm.professional" type='rich'></v-detailItem>
                    <v-detailItem label="身份证号" :value="viewForm.user.idNumber" type='rich'></v-detailItem>
                    ...
                    <v-detailItem label="电话" :value="viewForm.user.mobile"></v-detailItem>
                ...
                <el-col :span="12">
                  ...
                  <v-detailItem label="Email " :value="viewForm.user.email"></v-detailItem>
                </el-col>
            </el-row>
...
export default {
    ...
    methods: {
        ...
        getDetail(mid,id) {
          Api.society.getMemberDetail(mid,id).then((res) => {
            if(res){
              res.user.sex = this.formatSex(res.user.sex);
              this.viewForm = res;
            }
          });
        }
