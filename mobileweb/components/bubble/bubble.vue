...
export default {
  ...
  mounted() {
    ...
    this.initRadius = 24 * this.ratio
    this.minHeadRadius = 18 * this.ratio
    this.minTailRadius = 11 * this.ratio
    this.initArrowRadius = 16 * this.ratio
    this.minArrowRadius = 12 * this.ratio
    this.arrowWidth = 3 * this.ratio
    this.maxDistance = 46 * this.ratio
    this.initCenterX = 31 * this.ratio
    this.initCenterY = 31 * this.ratio
    this.headCenter = {
      x: this.initCenterX,
      y: this.initCenterY
    }
